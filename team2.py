...
DIRECTIONS: Each student will edit his own "player" code to attempt to score the highest score.
Scroll down and look at player "0" which is my example player, note I added my name in in two places,
you should do the same on your player code. Run the code and decide which type of player you
want to be, or write your own code. YOU MUST make sure the code functions with no errors before you
...
def get_action(player, history, opponent_history, score, opponent_score, getting_team_name=False):
    ...
    #
        ...
        if getting_team_name:
            return 'anonymousxxxIlluminatixxx420xxx360noscopexxx'
        else:
            if len(opponent_history)==0: #It's the first round: collude
                return 'c'
            elif history[-1]=='c' and opponent_history[-1]=='b':
